Return a complete corrected Recipe JSON object only. Do not use tools or workspace. Correct only the report issues.
...
# Cohort G preregistered natural-language prompts

These prompts were registered before any Cohort G model output. Each Recipe author receives the frozen contract snapshot and only its own prompt; the acceptance specification is not supplied.

## G1

Create a complete buildable 2D projectile Recipe with ID `g1_cinder` for `mobile_medium`: a compact cinder with a smaller core, narrower trail, fewer embers, and a restrained impact.

## G2

Create a complete buildable 2D projectile Recipe with ID `g2_lantern` for `pc_editor`: a large lingering lantern-like fireball with a larger core, longer trail, longer-lived embers, and a larger shockwave.

## G3

Create a complete buildable 2D projectile Recipe with ID `g3_needle` for `mobile_medium`: a small precise needle of fire. It must omit optional trail and ember modules, retain a smaller body, and use a restrained impact.

## G4

Create a complete buildable 2D projectile Recipe with ID `g4_whisper` for `pc_editor`: a quiet thin orb with a narrow trail, no ember module, a slower impact burst, and no larger shockwave.

## G5

Create a complete buildable 2D projectile Recipe with ID `g5_flare` for `mobile_medium`: a bright strong flare with at least the standard core and ember intensity, a stronger impact burst, and a larger shockwave.

## P1

Return a Patch only that reduces the canonical travel embers emission rate to 9.

## P2

Return a Patch only that disables the canonical travel embers module.

## P3

Return a Patch only that adds a second ember module named `lighter_embers` to canonical travel, attached to `core`.


PREVIOUS RAW ARTIFACT:
{"recipeVersion":1,"revision":1,"id":"g3_needle","name":"Needle of Fire","dimension":"2d","archetype":"projectile","style":"stylized","targetProfile":"mobile_medium","randomSeed":3715928559,"metadata":{"createdBy":"cohort_g","templateCatalogVersion":"1"},"stages":[{"id":"launch","trigger":"on_launch","modules":[{"id":"g3_needle_launch_flash","kind":"impact_flash","templateId":"PFT_2D_LaunchFlash","parameters":{"lifetime":0.06,"size":0.45}}]},{"id":"travel","trigger":"after_previous","modules":[{"id":"g3_needle_core","kind":"energy_body","templateId":"PFT_2D_FireCore","parameters":{"scale":0.6}}]},{"id":"impact","trigger":"on_hit","modules":[{"id":"g3_needle_impact_core_flash","kind":"energy_body","templateId":"PFT_2D_FireCore","parameters":{"scale":0.6}},{"id":"g3_needle_impact_burst","kind":"impact_burst","templateId":"PFT_2D_FireImpact","parameters":{"count":8,"speed":1.5}},{"id":"g3_needle_shockwave","kind":"shockwave","templateId":"PFT_2D_Shockwave","parameters":{"lifetime":0.12,"endSize":1.2}}]}]}
...
COMPLETE PREVIOUS MACHINE REPORT:
{
  ...
  "entries": [
    ...
    },
    {
      "code": "E101",
      "severity": "error",
      "path": "/stages/launch/modules/g3_needle_launch_flash/enabled",
      "message": "Required field is missing.",
      "actualValue": null,
      "allowedRange": null
    },
    ...
    },
    {
      "code": "E101",
      "severity": "error",
      "path": "/stages/travel/modules/g3_needle_core/enabled",
      "message": "Required field is missing.",
      "actualValue": null,
      "allowedRange": null
    },
    ...
    },
    {
      "code": "E101",
      "severity": "error",
      "path": "/stages/impact/modules/g3_needle_impact_core_flash/enabled",
      "message": "Required field is missing.",
      "actualValue": null,
      "allowedRange": null
    },
    {
      "code": "E101",
      "severity": "error",
      "path": "/stages/impact/modules/g3_needle_impact_burst/enabled",
      "message": "Required field is missing.",
      "actualValue": null,
      "allowedRange": null
    },
    {
      "code": "E101",
      "severity": "error",
      "path": "/stages/impact/modules/g3_needle_shockwave/enabled",
      "message": "Required field is missing.",
      "actualValue": null,
      "allowedRange": null
    }
