...
namespace VFXComposer.Tests.EditMode
{
    public sealed class S12BSlashCompilerTests
    {
        ...
        {
            Assert.That(Hash(File.ReadAllBytes(Absolute("Assets/VFX/Recipes/fireball-2d.default.json"))), Is.EqualTo("53C308EBD4C5DCED06A65618A71ECAB27955F160A174EB7CB91CDB4CBBEEDB88")); Assert.That(Hash(File.ReadAllBytes(Absolute("Assets/VFX/Recipes/fireball-3d.default.json"))), Is.EqualTo("1311E824313C3043EC6F75B4A086BB8A7D96FCE9408117D929D3C82E25B60AF2")); Assert.That(AssetDatabase.AssetPathToGUID("Assets/VFX/Generated/fireball_2d/VFX_Fireball_2D.prefab"), Is.EqualTo("edfdb8327c7bd234c94f0f4338c35816")); Assert.That(AssetDatabase.AssetPathToGUID("Assets/VFX/Generated/fireball_3d/VFX_Fireball_3D.prefab"), Is.EqualTo("27d60143a7650dd4fb850abed3ca178b")); Assert.That(GateHash("Assets/VFX/Generated/fireball_2d"), Is.EqualTo("21C9002CFB4D13066B6ED3DEB78789BEFB74690783A93E364BCC495FD9067120")); Assert.That(GateHash("Assets/VFX/Generated/fireball_3d"), Is.EqualTo("001452D39F72694BB8368E602CAFF4495EBA46085A539068F765917C11D72058")); CollectionAssert.IsSubsetOf(new[] { "fireball_2d", "fireball_3d", "slash_3d_stylized", "frost_impact_2d" }, Directory.GetDirectories(Absolute(S12SlashCompiler.GeneratedRoot)).Select(Path.GetFileName).ToArray(), "Protected outputs remain exact; later approved batches may add new output folders.");
        }
