...
namespace VFXComposer.Tests.EditMode
{
    public sealed class S12ASlashDomainAndAssetsTests
    {
        ...
        public void S12V1Protection_FrozenRecipesGuidsGeneratedManifestsAndDirectorySetRemainExact()
        {
            ...
            var generated = Absolute("Assets/VFX/Generated"); CollectionAssert.IsSubsetOf(new[] { "fireball_2d", "fireball_3d", "slash_3d_stylized", "frost_impact_2d" }, Directory.GetDirectories(generated).Select(Path.GetFileName).ToArray(), "Protected formal outputs must remain present while later approved batches may add new outputs."); Assert.That(AssetDatabase.AssetPathToGUID("Assets/VFX/Generated/slash_3d_stylized/VFX_Slash_3D_Stylized.prefab"), Is.EqualTo("0dc223c2ffbe2c14aa24f424440f1cd2")); Assert.That(File.Exists(Path.Combine(generated, "slash_3d_stylized", "BuildManifest.json")), Is.True); Assert.That(Directory.GetFiles(Path.Combine(generated, "fireball_2d"), "*", SearchOption.AllDirectories).Length, Is.EqualTo(30)); Assert.That(Directory.GetFiles(Path.Combine(generated, "fireball_3d"), "*", SearchOption.AllDirectories).Length, Is.EqualTo(20)); Assert.That(DirectoryManifestHash(Path.Combine(generated, "fireball_2d")), Is.EqualTo("C875279AE2DC21AB1B8631F44C02B39FFA4CB57EA542608BFAC2D8809B7B07B2")); Assert.That(DirectoryManifestHash(Path.Combine(generated, "fireball_3d")), Is.EqualTo("001452D39F72694BB8368E602CAFF4495EBA46085A539068F765917C11D72058"));
        }
